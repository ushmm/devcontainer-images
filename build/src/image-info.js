...
import * as imageContentUtils from "./utils/image-content-extractor.js";
import * as componentFormatterFactory from "./utils/component-formatter-factory.js";
import * as markdownFormatterFactory from "./utils/markdown-formatter-factory.js";
...
async function generateReleaseNotesPart(
  ...
  releaseNotesVariantPartTemplate =
    ...
    handlebars.compile(
      await asyncUtils.readFile(
        path.join(__dirname, "..", "assets", "release-notes-variant-part.md"),
      ),
    );
...
export { generateImageInformationFiles };
